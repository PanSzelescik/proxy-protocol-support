...
Proxy Protocol Support is a Fabric mod which adds support for [Proxy Protocol (HAProxy)](https://www.haproxy.com/blog/haproxy/proxy-protocol/ "Proxy Protocol (HAProxy)") for your Minecraft server.
...
Supports Minecraft versions 1.14-1.18.2 and probably snapshots (untested)
